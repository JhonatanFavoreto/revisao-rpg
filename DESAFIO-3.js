...
let monteMagos = ["Biblioteca Alfa", "Armadilha Elemental", "Torre do Futuro"];
let tesouroColetado = [];
...
console.log("");
console.log("CAPÍTULO 2: Explorando o monte dos magos");

// Explorando cada casa usando for tradicional
console.log("Começando exploração dos " + monteMagos.length + " casas místicas...");

for (let i = 0; i < monteMagos.length; i++) {
console.log("Casa " + (i + 1) + ": " + monteMagos[i]);

// Lógica diferente para cada sala baseada no índice
if (i === 0) {
console.log(nomePersonagem + " encontra mapas antigos!");
experiencia += 50;
} else if (i === 1) {
